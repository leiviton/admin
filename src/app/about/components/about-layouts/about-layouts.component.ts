...
export class AboutLayoutsComponent implements OnInit {
    options: object = [
        ...
        },
        {
            ...
            description:
                'Configure independant options for your layout in json format',
            icon: 'server'
        },
        {
            title: 'Fixed layout vs Static',
            description:
                'Configured according to your preferenes to be fixed or static',
            icon: 'navigation'
        },
        {
            title: 'Mobile enhanced',
            description:
                'The layouts are carefully developed to play nicely on mobile devices',
            icon: 'globe'
        }
    ];
